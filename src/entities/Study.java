...
public class Study  implements java.io.Serializable {
    ...
    public Study(Integer idReport, int idUser, String name, String studyPhase, String condition, String intervention, String officalTitle, String sponseredBy, String infoProvidedBy, Date startDate, Date endDate, int idCatalog, String studyType, int idDrug) {

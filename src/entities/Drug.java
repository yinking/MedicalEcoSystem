 ...
 */
@Entity
@Table(name = "Drug", catalog = "MedicalEcoSystem"
)
public class Drug implements java.io.Serializable {
    ...
    public Drug(String drugNumber, String formula, String uses, String manufature, String route, String indication, Integer idUser, int idDrugCatalog) {
    ...
    public String toString() {
        return drugNumber; //To change body of generated methods, choose Tools | Templates.
    }

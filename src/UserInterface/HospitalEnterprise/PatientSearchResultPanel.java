 ...
 * @author GladysWang
 */
public class PatientSearchResultPanel extends javax.swing.JPanel {

    /**
     * Creates new form MessagePanel
     */
    public PatientSearchResultPanel(List<Patients> list) {
        initComponents();
        popupTable(list);
    }

    private void popupTable(List<Patients> list) {

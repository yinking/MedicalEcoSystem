...
import entities.DoctorDepartment;
...
public class RegisterDoctor extends JDialog {
    ...
    public RegisterDoctor(JFrame parent) throws SQLException {
        ...
        middleNameField.setMinimumSize(new Dimension(200, 20));
        ...
        designationField.setMinimumSize(new Dimension(200, 20));
        bloodModel.addElement("AB-");
        emailAddress = new JLabel("Email Address: ");
        emailAdressField = new JTextField(20);
        bloodModel.addElement("O-");
        emailAdressField.setMinimumSize(new Dimension(200, 20));
        bloodModel.addElement("O+");
        academicqualification = new JLabel("Academic Qualification: ");
        academicqualificationField = new JTextField(20);
        bloodgroupBox.setModel(bloodModel);

        academicqualificationField.setMinimumSize(new Dimension(200, 20));
...
//                                                                                                                                                                                                        SystemUsersController sc = new SystemUsersController();
    ...
    private void initCombox() {
        DoctorDepartmentDao dao = new DoctorDepartmentDao();

        departmentBox.removeAllItems();
        for (DoctorDepartment c : dao.findAll()) {
            departmentBox.addItem(c);
        }
    }
    ...
    private void layoutControls() {
        ...
        addGridItems(doctorsPanel, firstName, 0, 0, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, mobileNo, 3, 0, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, avatar, 6, 0, 1, 2, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, firstNameField, 1, 0, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, mobileNoField, 4, 0, 2, 1, GridBagConstraints.WEST);

        addGridItems(doctorsPanel, middleName, 0, 1, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, bloodgroup, 3, 1, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, middleNameField, 1, 1, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, bloodgroupBox, 4, 1, 2, 1, GridBagConstraints.WEST);

        addGridItems(doctorsPanel, lastName, 0, 2, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, academicqualification, 3, 2, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, lastNameField, 1, 2, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, academicqualificationField, 4, 2, 2, 1, GridBagConstraints.WEST);

        addGridItems(doctorsPanel, addressno, 0, 3, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, Specialization, 3, 3, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, addressnoField, 1, 3, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, specializationField, 4, 3, 2, 1, GridBagConstraints.WEST);

        addGridItems(doctorsPanel, emailAddress, 0, 4, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, Designation, 3, 4, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, emailAdressField, 1, 4, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, designationField, 4, 4, 2, 1, GridBagConstraints.WEST);

        addGridItems(doctorsPanel, gender, 0, 5, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, departmentname, 3, 5, 1, 1, GridBagConstraints.EAST);
        addGridItems(doctorsPanel, maleRadioButton, 1, 5, 2, 1, GridBagConstraints.WEST);
        addGridItems(doctorsPanel, departmentBox, 4, 5, 2, 1, GridBagConstraints.WEST);
